...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      // Fundo e bordas em cinza (modo claro e escuro)
      "rounded-lg border border-gray-300 bg-gray-100 text-gray-800 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100",
      className
    )}
    {...props}
  />
